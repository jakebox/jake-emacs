;;; jake-doom-plain-theme.el --- inspired by gko's plain theme for VSCode


(require 'doom-themes)

(defgroup jake-doom-plain-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom jake-doom-plain-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'jake-doom-plain-theme
  :type 'boolean)
...
(def-doom-theme jake-doom-plain
...
;;; jake-doom-plain-theme.el ends here
