 ...
 '(org-ql-views
   '(("Columbia Todo" :buffers-files org-agenda-files :query
	  ...
	  ((:name "Personal:" :tag "p" :order 10)
	   ...
	   (:name "Contemporary Civilization:" :tag "cc")
	   (:name "Artificial Intelligence:" :tag "ai")
	   (:name "Computer Science Theory:" :tag "cst")
	   (:name "Universal Timekeepers:" :tag "ut")
	   (:name "Linear Algebra & Probability:" :tag "lp"))
	  :narrow nil)
	 ("All Todos" :buffers-files
	  ...
	  ((:name "Personal:" :tag "p" :order 10)
	   ...
	   (:name "ArtHum" :tag "art")
	   (:name "NLP:" :tag "nlp")
	   (:name "Latin American Civ:" :tag "civ")
	   (:name "Fundies:" :tag "csp")
	   (:name "Robotics" :tag "bot"))
	  :narrow nil)
