(custom-set-variables
 ...
 '(org-agenda-files
   '("~/Dropbox/notes/columbia/academic_planning.org" "/Users/jake/Dropbox/org/work.org"))
 '(org-ql-views
   '(("Columbia Todos" :buffers-files
	  ("/Users/jake/Dropbox/org/work.org")
	  :query
	  (and
	   (tags "columbia")
	   (todo))
	 ...
	 ("Refile" :buffers-files
	  ...
	  :super-groups
	  ((:auto-outline-path)))
	 ("CPB Articles All" :buffers-files "~/Dropbox/org/cpb.org" :query
	  (tags "article")
	  :title "CPB Articles All" :super-groups
	  ((:auto-outline-path)))
	 ("CPB Articles Notes on Life" :buffers-files "~/Dropbox/org/cpb.org" :query
	  (and
	   (olps "Notes on Life")
	   (tags "article"))
 ...
 '(package-selected-packages
   '(org-vcard hl-prog-extra org-preview-html org-preview-html-mode cape fontaine pdf-tools tablist doom-modeline pyvenv org-super-agenda visual-fill-column evil popper writeroom-mode windresize which-key web-mode use-package unfill undo-fu svg-lib super-save smartparens simpleclip shrink-path reveal-in-osx-finder restart-emacs rainbow-mode python-mode presentation ox-reveal ox-hugo org-tree-slide org-superstar org-real org-ql org-gcal org-download org-appear org-analyzer mw-thesaurus modus-themes mixed-pitch magit kaolin-themes ivy-prescient ivy-hydra htmlize hl-todo hide-mode-line gnuplot general gcmh flyspell-correct-ivy evil-surround evil-snipe evil-org evil-collection evil-anzu esxml elpy doom-themes diminish deft dashboard counsel centered-cursor-mode burly bufler auto-virtualenv all-the-icons-ivy-rich ace-window))
